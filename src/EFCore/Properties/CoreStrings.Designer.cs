...
namespace Microsoft.EntityFrameworkCore.Diagnostics.Internal
{
    ...
    public static class CoreResources
    {
        ...
        /// </summary>
        public static EventDefinition LogClientEvaluationWithEntity(IDiagnosticsLogger logger)
        {
            var definition = ((LoggingDefinitions)logger.Definitions).LogClientEvaluationWithEntity;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((LoggingDefinitions)logger.Definitions).LogClientEvaluationWithEntity,
                    logger,
                    static logger => new EventDefinition(
                        logger.Options,
                        CoreEventId.ClientEvaluationWithEntity,
                        LogLevel.Information,
                        "CoreEventId.ClientEvaluationWithEntity",
                        level => LoggerMessage.Define(
                            level,
                            CoreEventId.ClientEvaluationWithEntity,
                            _resourceManager.GetString("LogClientEvaluationWithEntity")!)));
            }
